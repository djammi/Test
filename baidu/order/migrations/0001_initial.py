    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(verbose_name='支付方式', default=1, choices=[(1, '待支付'), (2, '待发货'), (4, '待评价'), (5, '已完成'), (3, '待收货')])),
                ('status', models.SmallIntegerField(verbose_name='订单状态', default=1, choices=[(1, '待支付'), (2, '待发货'), (4, '待评价'), (5, '已完成'), (3, '待收货')])),
                ('trade_id', models.CharField(verbose_name='支付编号', max_length=100, unique=True, blank=True, null=True)),
                ('addr', models.ForeignKey(verbose_name='收货地址', to='gao.Address')),
                ('passport', models.ForeignKey(verbose_name='下单账户', to='gao.Passport')),
            ],
            options={
